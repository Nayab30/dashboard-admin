 <div class="sidebar-menu-container">
                        <ul class="sidebar-menu mt-4 mb-4">
                            <li class="parent">
                                <a href="dashboard.php" class=""><i class="fa-solid fa-child mr-3"> </i>
                            ...
                            <li class="parent">
                                <a href="vaccinedate.php" class=""><i class="fa-solid fa-syringe mr-3"></i>
                            ...
                            <li class="parent">
                                <a href="vaccinelist.php" class=""><i class="fa-solid fa-clipboard-list mr-3"></i>
                            ...
                            <li class="parent">
                                <a href="hospital.php" class=""><i class=" fa-solid fa-hotel mr-3"></i>
                                    <span class="none">Hospitals<i class=" pull-right align-bottom"></i></span>
                                </a>
                                
                            </li>
                            <li class="parent">
                                <a href="adminlogout.php" class=""><i class="fa-solid fa-right-from-bracket mr-3"></i>
